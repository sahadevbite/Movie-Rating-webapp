	...
	<body>
      ...
      <form method="POST"  action="Rating3">
						<div class="content">
							<div class="row">
								<div class="col-md-6">
									<figure class="movie-poster"><img src="dummy/jolly1.jpg" alt="#"></figure>
								</div>
								<div class="col-md-6">
									<h2 class="movie-title">Jolly LLB 2</h2>
									<div class="movie-summary">
										<p>An ambitious lawyer (Akshay Kumar) finds himself in a battle with a ruthless advocate after making an innocent mistake.<p/>
									</div>
									...
									<!--  	<li><strong> Give Rating:</strong> 
										...
										<li><strong>Premiere:</strong> 10 February 2017</li>
										<li><strong>Category:</strong> Animation/Adventure/Comedy</li>
									</ul>

									<ul class="starring">
										<li><strong>Directors:</strong> Subhash Kapoor</li>
										<li><strong>Writers:</strong>Subhash Kapoor</li>
										<li><strong>Stars:</strong>  	Akshay Kumar,
Annu Kapoor,
Huma Qureshi,
Saurabh Shukla</li>
									</ul>
