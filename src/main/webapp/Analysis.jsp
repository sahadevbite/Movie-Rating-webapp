			...
			<main class="main-content">
				<div class="container">
					<div class="page">
						...
						<h2 class="section-title">Analysis Of Movies Based On User Rating</h2>
****************************************************************************************************************
<br><br>
            ...
            String ok2 = (String) request.getAttribute("ok2");

        %>

        <br>
       <h3> Movie Name    : <%=mv_name%> </h3>
        <br><br>
         <font color="red">Very Bad Movie</font>   : <%=ok%>% Pepole Says
        <br><br>
        <br><br>
        <font color="blue">Average Movie</font>  : <%=ok1%>% Pepole Says
        <br><br>
        <br><br>
        <font color="green">Very Good Movie</font>  : <%=ok2%>% Pepole Says 
        <br><br>
