...
<html lang="en">
	...
	<body>
      ...
      <form method="POST"  action="Rating1">
						<div class="content">
							<div class="row">
								<div class="col-md-6">
									<figure class="movie-poster"><img src="dummy/ms1.jpg" alt="#"></figure>
								</div>
								<div class="col-md-6">
									<h2 class="movie-title">MS Dhoni</h2>
									<div class="movie-summary">
										<p>Ranchi lad M S Dhoni aspires to play cricket for India. Though he initially tries to please his father by taking up a job with the Indian Railways, he ultimately decides to chase his dreams.<p/>
									</div>
									...
									<!--  	<li><strong> Give Rating:</strong> 
										...
										<li><strong>Length:</strong> 3h 40m</li>
										<li><strong>Premiere:</strong> 30 September 2016</li>
										<li><strong>Category:</strong>Biography, Drama, Sport</li>
									</ul>

									<ul class="starring">
										<li><strong>Directors:</strong> Neeraj Pandey</li>
										<li><strong>Writers:</strong> Neeraj Pandey</li>
