...
<html lang="en">
	...
	<body>
			...
			<header class="site-header">
				<div class="container">
					<a href="index.html" id="branding">
						...
						<div class="logo-copy">
							<h1 class="site-title">Movies Analysis</h1>
      ...
      <form method="POST"  action="Rating3">
						<div class="content">
							<div class="row">
								<div class="col-md-6">
									<figure class="movie-poster"><img src="dummy/badri1.jpg" alt="#"></figure>
								</div>
								<div class="col-md-6">
									<h2 class="movie-title">Badrinath Ki Dulhania</h2>
									<div class="movie-summary">
										<p>A man (Varun Dhawan) and a woman (Alia Bhatt) fall in love despite their opposing views on gender and life in general.<p/>
									</div>
									...
									<!--  	<li><strong> Give Rating:</strong> 
										...
										<li><strong>Length:</strong> 2h 20m</li>
										<li><strong>Premiere:</strong> 22 March 2013 (USA)</li>
										<li><strong>Category:</strong> Animation/Adventure/Comedy</li>
									</ul>

									<ul class="starring">
										<li><strong>Directors:</strong>  Shashank Khaitan</li>
										<li><strong>Writers:</strong>  	Shashank Khaitan</li>
										<li><strong>Stars:</strong>  	Varun Dhawan,
Alia Bhatt,
Gauahar Khan,
Mohit Marwah,
Aakanksha Singh</li>
